...
export const NH_EXPORT_FORMAT = 'Newick';
...
export const OFF_FEATURE = 'off';
export const ORDINAL_SCALE = 'ordinal';
export const PDF_EXPORT_FORMAT = 'PDF';
export const PHYLOXML_EXPORT_FORMAT = 'phyloXML';
export const PNG_EXPORT_FORMAT = 'PNG';
export const MSA_RESIDUE = 'MSA Residue';
export const RESET_SEARCH_A_BTN_TOOLTIP = 'reset (remove) search result A';
export const RESET_SEARCH_B_BTN_TOOLTIP = 'reset (remove) search result B';
...
export const SPECIES_FEATURE = 'Species';
export const SVG_EXPORT_FORMAT = 'SVG';
...
export const BL_COLLAPSE_LABEL = 'bl_col_label';
export const BRANCH_COLORS_CB = 'brnch_col_cb';
export const BRANCH_DATA_FONT_SIZE_SLIDER = 'bdfs_sl';
export const BRANCH_EVENTS_CB = 'brevts_cb';
export const BRANCH_LENGTH_VALUES_CB = 'bl_cb';
export const BRANCH_VIS_CB = 'branchvis_cb';
export const BRANCH_WIDTH_SLIDER = 'bw_sl';
export const CLADOGRAM_BUTTON = 'cla_b';
export const COLLAPSE_BY_FEATURE_SELECT = 'coll_by_feat_sel';
export const COLOR_PICKER = 'col_pick';
export const COLOR_PICKER_LABEL = 'colorPickerLabel';
export const CONFIDENCE_VALUES_CB = 'conf_cb';
export const CONTROLS_0 = 'controls0';
export const CONTROLS_1 = 'controls1';
export const DECR_BL_COLLAPSE_LEVEL = 'decr_blcl';
export const DECR_DEPTH_COLLAPSE_LEVEL = 'decr_dcl';
export const DEPTH_COLLAPSE_LABEL = 'depth_col_label';
export const DISPLAY_DATA_CONTROLGROUP = 'display_data_g';
export const DOWNLOAD_BUTTON = 'dl_b';
export const DYNAHIDE_CB = 'dynahide_cb';
export const EXPORT_FORMAT_SELECT = 'exp_f_sel';
export const EXTERNAL_FONT_SIZE_SLIDER = 'entfs_sl';
export const EXTERNAL_LABEL_CB = 'extl_cb';
export const EXTERNAL_NODES_CB = 'extn_cb';
export const INCR_BL_COLLAPSE_LEVEL = 'incr_blcl';
export const INCR_DEPTH_COLLAPSE_LEVEL = 'incr_dcl';
export const INTERNAL_FONT_SIZE_SLIDER = 'intfs_sl';
export const INTERNAL_LABEL_CB = 'intl_cb';
export const INTERNAL_NODES_CB = 'intn_cb';
export const LABEL_COLOR_SELECT_MENU = 'lcs_menu';
export const LEGEND = 'legend';
export const LEGEND_DESCRIPTION = 'legendDescription';
export const LEGEND_LABEL = 'legendLabel';
export const LEGENDS_HORIZ_VERT_BTN = 'legends_horizvert';
export const LEGENDS_MOVE_DOWN_BTN = 'legends_mdown';
export const LEGENDS_MOVE_LEFT_BTN = 'legends_mleft';
export const LEGENDS_MOVE_RIGHT_BTN = 'legends_mright';
export const LEGENDS_MOVE_UP_BTN = 'legends_mup';
export const LEGENDS_RESET_BTN = 'legends_rest';
export const LEGENDS_SHOW_BTN = 'legends_show';
export const MIDPOINT_ROOT_BUTTON = 'midpointr_b';
export const MSA_RESIDUE_VIS_CURR_RES_POS_LABEL = 'seq_pos_label_curr_pos';
export const MSA_RESIDUE_VIS_CURR_RES_POS_SLIDER_1 = 'seq_pos_slider_1';
export const MSA_RESIDUE_VIS_DECR_CURR_RES_POS_BTN = 'seq_pos_decr_pos';
export const MSA_RESIDUE_VIS_INCR_CURR_RES_POS_BTN = 'seq_pos_incr_pos';
export const NODE_BORDER_COLOR_SELECT_MENU = 'nbcolors_menu';
export const NODE_DATA = 'node_data_dialog';
export const NODE_EVENTS_CB = 'nevts_cb';
export const NODE_FILL_COLOR_SELECT_MENU = 'nfcolors_menu';
export const NODE_NAME_CB = 'nn_cb';
export const NODE_SHAPE_SELECT_MENU = 'nshapes_menu';
export const NODE_SIZE_SELECT_MENU = 'nsizes_menu';
export const NODE_SIZE_SLIDER = 'ns_sl';
export const NODE_VIS_CB = 'nodevis_cb';
export const ORDER_BUTTON = 'ord_b';
export const PHYLOGRAM_ALIGNED_BUTTON = 'phya_b';
export const PHYLOGRAM_BUTTON = 'phy_b';
export const PHYLOGRAM_CLADOGRAM_CONTROLGROUP = 'phy_cla_g';
export const PROG_NAME = 'progname';
export const PROGNAMELINK = 'prognamelink';
export const RESET_SEARCH_A_BTN = 'reset_s_a';
export const RESET_SEARCH_B_BTN = 'reset_s_b';
export const RETURN_TO_SUPERTREE_BUTTON = 'ret_b';
export const SEARCH_FIELD_0 = 'sf0';
export const SEARCH_FIELD_1 = 'sf1';
export const SEARCH_OPTIONS_CASE_SENSITIVE_CB = 'so_cs_cb';
export const SEARCH_OPTIONS_COMPLETE_TERMS_ONLY_CB = 'so_cto_cb';
export const SEARCH_OPTIONS_GROUP = 'search_opts_g';
export const SEARCH_OPTIONS_NEGATE_RES_CB = 'so_neg_cb';
export const SEARCH_OPTIONS_REGEX_CB = 'so_regex_cb';
export const SEQUENCE_CB = 'seq_cb';
export const SHORTEN_NODE_NAME_CB = 'shortennodename_cb';
export const TAXONOMY_CB = 'tax_cb';
export const UNCOLLAPSE_ALL_BUTTON = 'unc_b';
export const ZOOM_IN_X = 'zoomin_x';
export const ZOOM_IN_Y = 'zoomout_y';
export const ZOOM_OUT_X = 'zoomout_x';
export const ZOOM_OUT_Y = 'zoomin_y';
export const ZOOM_TO_FIT = 'zoomtofit';

export const LABEL_COLOR_SELECT_MENU_2 = 'lcs_2_menu'; //~~
export const NODE_FILL_COLOR_SELECT_MENU_2 = 'nfcolors_2_menu';
export const NODE_BORDER_COLOR_SELECT_MENU_2 = 'nbcolors_2_menu';

export const LABEL_COLOR_SELECT_MENU_3 = 'lcs_3_menu'; //~~~
export const NODE_FILL_COLOR_SELECT_MENU_3 = 'nfcolors_3_menu';
export const NODE_BORDER_COLOR_SELECT_MENU_3 = 'nbcolors_3_menu';
