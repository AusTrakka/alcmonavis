...
export default class Controls {
  ...
  constructor(alc: alcmonavispoeschli, controls0?: string, controls1?: string) {
    ...
    (this.options = this.alcmonavis.options), (this.settings = this.alcmonavis.settings);
        ...
        if (this.alcmonavis.isAddVisualization2() && this.alcmonavis.specialVisualizations != null) {
          ...
          if ('Mutations' in this.alcmonavis.specialVisualizations) {
            ...
            if (mutations != null) {
              ...
              console.log(
                AP.MESSAGE +
                  'Setting special visualization property ref to: ' +
                  this.alcmonavis.visualizations2_applies_to_ref,
              );
              console.log(
                AP.MESSAGE +
              ...
              console.log(
                AP.MESSAGE + 'Setting special visualization color to: ' + this.alcmonavis.visualizations2_color,
              );
            }
          }
        }
          ...
          if ('Convergent_Mutations' in this.alcmonavis.specialVisualizations) {
            ...
            if (conv_mutations != null) {
              ...
              console.log(
                AP.MESSAGE +
                  'Setting special visualization property ref to: ' +
                  this.alcmonavis.visualizations3_applies_to_ref,
              );
              console.log(
                AP.MESSAGE +
                  'Setting special visualization property applies to to: ' +
              ...
              console.log(
                AP.MESSAGE + 'Setting special visualization color to: ' + this.alcmonavis.visualizations3_color,
              );
            }
          }
        }
    ...
    this.alcmonavis.AddHandler('showNodeName', (val: string | number | boolean | undefined) =>
      this.setCheckboxValue(AP.NODE_NAME_CB, val as boolean),
    );
    this.alcmonavis.AddHandler('showExternalLabels', (val: string | number | boolean | undefined) =>
      this.setCheckboxValue(AP.EXTERNAL_LABEL_CB, val as boolean),
    );
    this.alcmonavis.AddHandler('showInternalLabels', (val: string | number | boolean | undefined) =>
      this.setCheckboxValue(AP.INTERNAL_LABEL_CB, val as boolean),
    );
    this.alcmonavis.AddHandler('showExternalNodes', (val: string | number | boolean | undefined) =>
      this.setCheckboxValue(AP.EXTERNAL_NODES_CB, val as boolean),
    );
    this.alcmonavis.AddHandler('showInternalNodes', (val: string | number | boolean | undefined) =>
      this.setCheckboxValue(AP.INTERNAL_NODES_CB, val as boolean),
    );
    this.alcmonavis.AddHandler('showNodeVisualizations', (val: string | number | boolean | undefined) =>
      this.setCheckboxValue(AP.NODE_VIS_CB, val as boolean),
    );
    this.alcmonavis.AddHandler('showBranchVisualizations', (val: string | number | boolean | undefined) =>
      this.setCheckboxValue(AP.BRANCH_VIS_CB, val as boolean),
    );
    this.alcmonavis.AddHandler('searchUsesRegex', (val: string | number | boolean | undefined) =>
      this.setCheckboxValue(AP.SEARCH_OPTIONS_REGEX_CB, val as boolean),
    );
    this.alcmonavis.AddHandler('searchIsComplete', (val: string | number | boolean | undefined) =>
      this.setCheckboxValue(AP.SEARCH_OPTIONS_COMPLETE_TERMS_ONLY_CB, val as boolean),
    );
    ...
    $<HTMLSelectElement>('#' + AP.LABEL_COLOR_SELECT_MENU).on(
      'change',
      ((self: Controls) => {
    ...
    $<HTMLSelectElement>('#' + AP.LABEL_COLOR_SELECT_MENU_2).on(
      'change',
      ((self: Controls) => {
        const _: (this: HTMLSelectElement) => void = function () {
          const v = this.value;
    ...
    $<HTMLSelectElement>('#' + AP.LABEL_COLOR_SELECT_MENU_3).on(
      'change',
      ((self: Controls) => {
        const _: (this: HTMLSelectElement) => void = function () {
          const v = this.value;
    ...
    $<HTMLSelectElement>('#' + AP.NODE_FILL_COLOR_SELECT_MENU).on(
      'change',
      ((self: Controls) => {
        const _: (this: HTMLSelectElement) => void = function () {
          const v = this.value;
    ...
    $<HTMLSelectElement>('#' + AP.NODE_FILL_COLOR_SELECT_MENU_2).on(
      'change',
      ((self: Controls) => {
        const _: (this: HTMLSelectElement) => void = function () {
          const v = this.value;
    ...
    $<HTMLSelectElement>('#' + AP.NODE_FILL_COLOR_SELECT_MENU_3).on(
      'change',
      ((self: Controls) => {
        const _: (this: HTMLSelectElement) => void = function () {
          const v = this.value;
    ...
    $<HTMLSelectElement>('#' + AP.NODE_SHAPE_SELECT_MENU).on(
      'change',
      ((self: Controls) => {
        const _: (this: HTMLSelectElement) => void = function () {
          const v = this.value;
    ...
    $<HTMLSelectElement>('#' + AP.NODE_SIZE_SELECT_MENU).on(
      'change',
      ((self: Controls) => {
        const _: (this: HTMLSelectElement) => void = function () {
          const v = this.value;
  ...
  makeDisplayControl(): HTMLstring {
    ...
    if (this.alcmonavis.basicTreeProperties) {
      ...
      h = h.concat(
        this.makeCheckboxButton('External Labels', AP.EXTERNAL_LABEL_CB, 'to show/hide external node labels'),
      );
      ...
      if (this.alcmonavis.settings.showDynahideButton) {
        h = h.concat(
          this.makeCheckboxButton(
            'Dyna Hide',
            AP.DYNAHIDE_CB,
            'to hide external labels depending on expected visibility',
          ),
        );
      }
  ...
  makeControlButtons(): HTMLstring {
    ...
    h = h.concat(
      this.makeButton('R', AP.RETURN_TO_SUPERTREE_BUTTON, 'return to the supertree (if in subtree) (Alt+R)'),
    );
    h = h.concat('<br>');
  ...
  makeSearchControls(): HTMLstring {
    ...
    h = h.concat('<div class="' + AP.SEARCH_OPTIONS_GROUP + '">');
    h = h.concat(
      this.makeCheckboxButton('Neg', AP.SEARCH_OPTIONS_NEGATE_RES_CB, 'to invert (negate) the search results'),
    );
  ...
  makeSearchControlsCompact(): HTMLstring {
    ...
    h = h.concat(
      this.makeCheckboxButton('N', AP.SEARCH_OPTIONS_NEGATE_RES_CB, 'to invert (negate) the search results'),
    );
  ...
  makeVisualControls(): HTMLstring {
    ...
    h = h.concat(
      this.makeSelectMenu(
        ...
        '<br>',
        AP.NODE_SIZE_SELECT_MENU,
        'change the node size according to a property',
      ),
    );
    h = h.concat('</fieldset>');
    h = h.concat('</form>');
