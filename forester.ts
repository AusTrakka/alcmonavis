    ...
    export const forester = {
         ...
         * @returns {{}}
         */
        collectProperties: (phy: Forester.phylo, appliesTo: Forester.properties, externalOnly: boolean): Dict<Set<string>> => {
        ...
        shortenProperties: (phy: Forester.phylo, appliesTo: Forester.properties, externalOnly: boolean | undefined, sourceRef: string, targetRef: string) => {
            forester.preOrderTraversalAll(phy, function (n) {
                if (!externalOnly || externalOnly !== true || (!n.children && !n._children)) {
                    if (n.properties && n.properties.length > 0) {
                        var propertiesLength = n.properties.length;
        ...
        searchData: <T extends Forester.phylo>(query: string,
            phy: T,
         ...
         */
        parseNewHampshire: (nhStr: string, confidenceValuesInBrackets: boolean, confidenceValuesAsInternalNames: boolean): Forester.phylo => {
         ...
         */
        toNewHampshire: (phy: Forester.phylo, decPointsMax?: number, replaceChars?: boolean, writeConfidences?: boolean): string => {
